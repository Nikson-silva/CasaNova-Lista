...
function InfoItem({ children, icon, label }: InfoItemProps) {
    return (
        <div className="flex flex-col items-center justify-center gap-1 lg:flex-row lg:gap-3">
            ...
            <div className="text-[22px] font-medium leading-none text-[#263748]">{children}</div>
        </div>
    );
}
...
export function InvitationInfo() {
    return (
        <div className="flex flex-col gap-3.5 lg:gap-5 font-[Georgia]">
            ...
            <InfoItem icon={<MapPin aria-hidden="true" className="size-4" />} label="Local">
                <a
                ...
                >
                    <MapPin aria-hidden="true" className="size-4 fill-[#EF4E45] text-[#EF4E45]" />
                    Local do evento
                </a>
            </InfoItem>
        </div>
