    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="mx-auto mt-9 max-w-[480px] font-sans text-[15px] leading-6 text-[#718096] lg:mt-10">
          Com muita alegria, convidamos você para celebrar conosco este momento
          especial. Venha fazer parte da nossa nova história!
        </p>
        ...
        >
          <li className="flex gap-3 border border-[#D9ECF5] bg-[#F7FBFD] px-4 py-3">
            ...
            />
            <p className="text-[13px] leading-5 text-[#627489]">
              <span className="font-semibold text-[#263748]">Piscina:</span>{" "}
              O local possui piscina. Quem quiser aproveitar, não esqueça de
              levar sua roupa de banho.
            </p>
          </li>
          <li className="flex gap-3 border border-[#D9ECF5] bg-[#F7FBFD] px-4 py-3">
            <Beer
            ...
            />
            <p className="text-[13px] leading-5 text-[#627489]">
              <span className="font-semibold text-[#263748]">Bebidas:</span>{" "}
              Quem quiser beber no dia, lembre-se de levar sua própria bebida.
            </p>
          </li>
        </ul>
